...
<div id="append_parent"></div> 
  <div id="toptb" class="cl"> 
   <div class="wp"> 
    <div class="z"> 
     <a href="${path}/" title="${applicationScope.bbsinfo.name}"><img src="${path}/upload/${applicationScope.bbsinfo.logoimg}" alt="${applicationScope.bbsinfo.name}"  /></a> 
    </div> 
    ...
    <div class="y"> 
     ...
     <c:if  test="${!empty sessionScope.indexuser}">
      <a href="javascript:;" id="qing_user" onclick="showhidediv();" >${sessionScope.indexuser.loginname}<i></i></a> 
